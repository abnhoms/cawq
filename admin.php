...
// create page menu
$side_menu  = '';
$side_menu .= pageMenu('admin/setting_dashboard.php', 'dashboard', $lang['dashboard'], 97);
$side_menu .= pageMenu('admin/setting_chairman.php', 'crown', $lang['x_setting_chairman'], 100);
...
$side_menu .= pageMenu('admin/setting_members.php', 'users', $lang['manage_member'], 97);
...
$side_menu .= pageDropMenu('cubes', $lang['manage_module'], $drop3, 10);
